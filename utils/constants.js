...
// export const profileInfoName = profileBlock.querySelector(".profile__info-name"); //строка имени блока профиля
// export const profileInfoInterest = profileBlock.querySelector(".profile__info-interest");
